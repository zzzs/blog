...
<a id="aaa" href="#">点击我</a>
  <!-- <a id="aaaaa" href="#" download="aaa">download</a> -->
<script>

$("#aaa").click(function(){
  var Sel = document.getSelection();
  var SelLength = document.getSelection().text;
  console.log(SelLength);
  console.log(Sel);
  // SelLength.setStart(SelLength.startContainer,SelLength.startOffset-4);//获得当前range strat所在节点和偏移量，计算后作为参数
  // var text=SelLength.toString();//获得选择文本
