...
/*
* Laravel 在解决bindings 时存在问题
* 如果移除where中的一个条件时,它的绑定的值还在
* query => '... where del = ? and id = ?'
* bindings => [0, 2]
* reject后
* bindings => [0, 2]
* 详见 <https://github.com/laravel/framework/issues/4961>
* 此文件来自 <https://github.com/jarektkaczyk/laravel-global-scope>
*/
